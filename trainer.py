...
class Trainer(object):
    ...
    def test(self,save_fname_pkl='gaze_pred_smooth.pkl',save_fname_txt='results_smooth.txt'):
        """
        ...
        with open('./'+save_fname_pkl, 'wb') as fo:
            pickle.dump(tinydict,fo)
        np.savetxt(save_fname_txt, pred_gaze_all, delimiter=' ')
